...
export const Route = createFileRoute('/order/success')({ component: OrderSuccess })
  ...
  return (
    <div className="mx-auto mt-24 max-w-md space-y-4 px-4 text-center">
      ...
      <p className="text-muted-foreground">
        Payment received. We've started production and emailed your confirmation.
        Track progress anytime from your orders.
      </p>
